...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    ...
    <body>
        ...
        <div class="container-xxl">
            <h4 class="AmeberText" style="text-align:center"><?php echo $lang['beta_tester_leg'];?></h4>
            <div class="card-body card-body-cascade text-center">
                <form action="feedback_form_beta.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <div class="md-form mb-0">
                            <input style="color:white;" name="email_address" type="email" id="form80" class="form-control validate" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <div class="md-form mb-0">
                            <input style="color:white;" name="object" type="text" id="form82" class="form-control" required>
                            <label style="color:#FF8F00;" data-error="Incorrect" data-success="Brillant" for="form83"><?php echo $lang['objet'];?></label>
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                        <div class="md-form mb-0">
                            <textarea style="color:white;" name="feedback" type="text" id="form84" class="md-textarea form-control" rows="3" required></textarea>
                            <label style="color:#FF8F00;" for="form85"><?php echo $lang['feedback'];?></label>
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 text-center my-4">
                        <span class="waves-input-wrapper waves-effect waves-light"><input type="submit" name="send" value=<?php echo $lang['envoi-retour'];?> class="btn Mango btn-rounded"></span>
                        </div>
                    </div>
                    <!-- End of Fourth row -->
                </form>
