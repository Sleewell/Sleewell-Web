                ...
                <td style="width:80%;">
                    ...
                    <section class="section">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <!-- End of  Card -->
                            <span class="waves-input-wrapper waves-effect waves-light" style="width:100%;margin-top:1vw"><a id="RoutineManagerBtn" href="routine_manager.php" class="btn Mango btn-rounded" style="width:100%;text-decoration: none;"><?php echo $lang["routine-managerbtn"] ?></a><span>
                        </div>
                        <!-- End of  First column -->
                        <!-- Second column -->
